...
class FilesystemTest extends TestCaseAbstract
{
	...
	public function testGetIterator($root = null, $recursive = false, $filterArray = [], array $expectArray = [])
	{
		/* setup */
	...
	public function testGetArray($root = null, $recursive = false, $filterArray = [], array $expectArray = [])
	{
		/* setup */
	...
	public function testSortGetArray($root = null, $recursive = false, $filterArray = [], array $expectArray = [])
	{
		/* setup */
